...
<head>
  ...
  <title>پرینت سفارش | کنترل پنل</title>
  ...
  <section class="invoice">
    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">
          <i class="fa fa-globe"></i> شرکت فناوری اطلاعات
    ...
    <div class="row invoice-info">
      ...
      <div class="col-sm-4 invoice-col">
        ...
        <b>تاریخ پرداخت:</b> ۳ مرداد ۱۳۹۶<br>
        <b>اکانت:</b> 968-34567
      </div>
      <!-- /.col -->
    </div>
    ...
    <div class="row no-print">
      <div class="col-xs-12">
        ...
        <button type="button" class="btn btn-success pull-right"><i class="fa fa-credit-card"></i> تایید و پرداخت
        </button>
