...
<head>
  ...
  <title>ویرایشگرها | کنترل پنل</title>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
            ...
            <div class="box-body pad">
              <form>
                <textarea id="mytextarea" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"> این ویرایشگر راست چین و فارسی شده و تنظیمات آن به صورت اختصاصی تنظیم شده است...</textarea>
              </form>
            </div>
          </div>
          ...
          <!--<div class="box">
            <div class="box-header">
              <h3 class="box-title">ویرایشگر WYSIHTML5
              </h3>
            ...
            <div class="box-body pad">
              <form>
                <textarea id="mytextarea" placeholder="متن"
