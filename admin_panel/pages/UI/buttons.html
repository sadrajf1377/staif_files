    ...
    <section class="content">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">دکمه ها</h3>
            </div>
            <div class="box-body pad table-responsive">
              <p>برای ایجاد دکمه این کلاس را اضافه کنید <code>.btn</code></p>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">عرض کامل</h3>
            </div>
            <div class="box-body">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">دکمه های گروهی</h3>
            </div>
            <div class="box-body table-responsive pad">
              <p>
                برای ایجاد گروه دکمه کافیست دکمه ها را درون این تگ قرار دهید <br> <code>&lt;div class="btn-group"&gt;&lt;/div&gt;</code>
              </p>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">دکمه چسبیده به فرم</h3>
            </div>
            <div class="box-body">
              <p>آبشاری</p>
              ...
              <div class="input-group margin">
                <div class="input-group-btn">
                  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">ارسال
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">دکمه های ترکیبی</h3>
            </div>
            <div class="box-body">
              <!-- Split button -->
              <p>معمولی</p>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">دکمه های شبکه اجتماعی توسط <a href="https://github.com/lipis/bootstrap-social">Lipis</a>
              </h3>
            </div>
            <div class="box-body">
        ...
        <div class="col-md-6">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">دکمه های نرم افزاری</h3>
            </div>
            <div class="box-body">
              ...
              <a class="btn btn-app">
                <i class="fa fa-play"></i> استارت
              </a>
              <a class="btn btn-app">
                <i class="fa fa-repeat"></i> تکرار
              </a>
              <a class="btn btn-app">
                <i class="fa fa-pause"></i> استوپ
              </a>
              <a class="btn btn-app">
              ...
              <a class="btn btn-app">
                ...
                <i class="fa fa-barcode"></i> محصول
              </a>
              <a class="btn btn-app">
                <span class="badge bg-purple">891</span>
                <i class="fa fa-users"></i> کاربر
              </a>
              <a class="btn btn-app">
                <span class="badge bg-teal">67</span>
                <i class="fa fa-inbox"></i> سفارش
              </a>
              <a class="btn btn-app">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">رنگ های دیگر</h3>
            </div>
            <div class="box-body">
              <p>میتوانید رنگ و نوع را ترکیب کنید کلاس<code>.btn</code> را به همراه کلاس های دیگر قرار دهید
                <code>.bg-*</code></p>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">دکمه های گروهی عمودی</h3>
            </div>
            <div class="box-body table-responsive pad">

              <p>
                برای ایجاد گروه دکمه کافیست دکمه ها را درون این تگ قرار دهید <br> <code>&lt;div class="btn-group-vertical"&gt;&lt;/div&gt;</code>
              </p>
