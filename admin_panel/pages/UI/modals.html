  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="callout callout-info">
        <h4>توجه</h4>
        برای دیدن راهنمای کامل و استفاده بیشتر می توانید به
        <a href="http://getbootstrap.com/javascript/#modals" target="_blank">مستندات بوت استرپ</a>
        مراجعه کنید
      </div>
        ...
        <div class="col-xs-12">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">نمونه ها</h3>
            </div>
            <div class="box-body">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Primary مدال</h4>
              </div>
              <div class="modal-body">
                <p>محتوا</p>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Info مدال</h4>
              </div>
              <div class="modal-body">
                <p>محتوا</p>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Warning مدال</h4>
              </div>
              <div class="modal-body">
                <p>محتوا</p>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Success مدال</h4>
              </div>
              <div class="modal-body">
                <p>محتوا</p>
              </div>
